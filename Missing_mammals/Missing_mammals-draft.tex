...
\bigskip
\noindent A shorter version (2500 words) as been submitted to Biology Letters as an invited submission for a special issue blablabla\\
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=1\textwidth]{Missing_mammals/example_coverage.pdf}
