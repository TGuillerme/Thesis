...
% NC: Add here a quick note about the results.
Note that these analyses do not change our results except in... See % NC: Appropriate section 
for more details.
...
We selected every tip present at every stage % NC: What do you mean by stage? Every epoch? era? geological time slice? Sort this throughout or define stage.
