...
\chapter{Supplementary information to \Chapref{TEM_paper}}
...
The following analysis measures the performance of our parameters and algorithms choices to generate the ``complete'' matrix.
