...
%\begin{figure}[!htbp] % online version
\begin{figure}[!h] % print version
\centering
...
Values $>$ 0.95 denote significantly similar distributions and values $<$ 0.05 denote significantly different distributions.}} % Small tag for online version
