...
% §1 In this thesis, I combine both data to see how it goes with the TEM or STD.
% I've shown the sensitivity to missing data and the effort needed in collecting more data

% §2 but some people say it's useless
...
% §3 maybe a future direction should be to properly test it
In future what would be useful to test that properly
%Avoid getting in the literature review stylish stuff. MAKE IT SHORT
