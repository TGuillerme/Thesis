...
% NC Need to define shape, to many it's the 2D outline of an individual, here you mean biological variation in form. Cladistic characters definitely aren't giving you "shape" per se ar they? Maybe replace the word shape by form to save this problem? TG: I've changed shape to form + added what I mean by form.
...
% NC: Not sure how happy I am with the paragraph below. I tried to make it clearer what you mean, but it's not well justified WHY that would be important in a macro question versus the space. TG: I've added this sentence to make the point: what we want in macroevolutionary studies is to be able to describe biological patterns, not just variation in numbers.
...
% NC: I don't like this ending but it's ok. TG: to be honest I'm also not happy with this whole discussion (that's probably why it doesn't come out so well). I think it definitely contrasts in quality with the papers discussion where we were not weaving arms but actually describing and discussing what we found. Here it sounds more like a bullet point list of what to improve (first two parts) with dubious transitions and an final air brassing part...
