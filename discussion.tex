...
% NC: Not sure how happy I am with the paragraph below. I tried to make it clearer what you mean, but it's not well justified WHY that would be important in a macro question versus the space.
...
Even though some attempts have been made for measuring the efficiency % NC: What do you mean by efficiency? Efficient means doing something well and with as little time/money etc as possible. I think you might mean accuracy? or effectiveness?
...
% NC: Again not a great paragraph but it'll do.
...
Using data from both living and fossil species has lead to substantial improvements in macroevolutionary studies \citep{Finarelli2006,Slateretal2012,Slater2012MEE,SlaterPennel2014,pant2014complex,Mitchell2015}. % NC: That's a lot of citations with no explanation. How/why has it led to improvements? What di you mean by "improvements"
However, combining living and fossils species in such studies often requires extra work and specific expertise \citep[e.g.][]{ronquista2012} % NC: What kind of specific expertise?
...
% NC: I don't like this ending but it's ok.
