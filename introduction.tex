...
For example, nowadays crocodilians constitute a species poor group \citep[25 species;][]{uetz2010original} with a low range shapes and environments \citep[marine or freshwater;][]{Martin2008}. % TG: or add the number of species in each habitat? marine (2 \textit{sp.}) or freshwater (23 \textit{sp.})
...
In the case of \cite{Wiens2015}, not including fossil species might biase the true evolutionary of this clade. % TG: or maybe remove this sentence.
