...
This resulted in Total Evidence phylogenies were the topology are based on strong but valid \texit{a priori} topologies \citep[e.g. based on][for mammals]{meredithimpacts2011}, allowing biologists to use these phylogeny to test some macroevolutionary hypothesis.
